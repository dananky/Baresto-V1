...
$(document).ready(function () {
	...
	$(document).on('click', '.start_cooking_button', function () {
		...
		if ($('#single_order_' + sale_id).attr('data-order-type') == 'Dine In' || $('#single_order_' + sale_id).attr('data-order-type') == 'Take Away' || $('#single_order_' + sale_id).attr('data-order-type') == 'Delivery') {
