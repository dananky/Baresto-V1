...
foreach($food_menus as $single_menus){
    ...
    $menu_to_show .= '<div style="height: 150px;" class="single_item fix" id="item_'.$single_menus->id.'">';
...
foreach ($customers as $customer){
    ...
    if($customer->name=='Walk-in Customer'){
        ...
        $customers_option .= '<option value="'.$customer->id.'" '.$selected.'>'.$customer->name.'</option>';
    }
    ...
    $tables_modal .= '<div class="floatleft fix single_order_table" id="single_table_info_holder_'.$table->id.'">';
        ...
        $tables_modal .= '<div class="single_table_order_details_holder fix" id="single_table_order_details_holder_'.$table->id.'">';
            ...
            $tables_modal .= '<div class="bottom fix" id="single_table_order_details_bottom_'.$table->id.'">';
                $tables_modal .= '<input style="display:none" type="text" name="" placeholder="Order" class="floatleft bottom_order"  id="single_table_order_details_bottom_order_'.$table->id.'" readonly>';
                $tables_modal .= '<input style="display:none" type="text" name="" placeholder="Person" class="floatleft bottom_person" id="single_table_order_details_bottom_person_'.$table->id.'">';
                $tables_modal .= '<div><button style="width:300px;height:45px;font-size:16px;background-color: #b5d6f6" class="floatleft bottom_add" id="single_table_order_details_bottom_add_'.$table->id.'">Add</button></div>';
            $tables_modal .= '</div>';
        $tables_modal .= '</div>';
    $tables_modal .= '</div>';
...
foreach($new_orders as $single_new_order){
    ...
    if($i==1){
        ...
        $order_list_left .= '<div data-started-cooking="'.$total_kitchen_type_started_cooking_items.'" data-done-cooking="'.$total_kitchen_type_done_items.'" class="single_order fix" style="font-size:20px;" data-selected="unselected" id="order_'.$single_new_order->sales_id.'">';
    }
    ...
    <body id="body">
        ...
        <div class="wrapper fix">
            ...
            <!--<div id="main" onclick="closeNav()" style="margin-left: 320px">-->
                ...
                <div class="main_left fix" style="margin-right: 15px">
                    <div class="holder fix">
                        <div id="running_order_header">
                            <h3><?php echo lang('running_order'); ?></h3>
                            <span id="refresh_order"><i class="fas fa-sync-alt"></i></span>
                        ...
                        <div style="position: absolute;bottom: 5px;width:100%;" id="left_side_button_holder_absolute">
                            <?php if($this->session->userdata('pre_or_post_payment') == "Post Payment"){?>
                                <button class="operation_button fix" id="modify_order" style="background-color:#dc3545;"><i class="fas fa-edit"></i> Edit </button>
                            <?php } ?>
                            <!--<button class="operation_button fix" id="single_order_details"><i class="fas fa-info-circle"></i> <?php echo lang('order_details'); ?></button>-->
                            <button class="operation_button fix" id="print_kot" style="background-color:#33c15d;color:white;height:50px;border:none;"><i class="fas fa-print"></i> <?php echo lang('print_kot'); ?></button>
			    <button class="operation_button fix" id="print_bill" style="background-color:#6d91f0;color:white;height:50px;border:none;"><i class="fas fa-file-invoice"></i><?php echo " "?>Print Bill</button>
                    ...
                    <div style="position: absolute;bottom: 1px;width: 100%" id="bottom_absolute">
                        ...
                        <table cellspacing="0" cellpadding="0">
                                ...
                                <tr id="delivery_change2" style="background-color:#F5F5F5;">
                                    ...
                                    <td style="text-align:right;padding-right:10px;">
                                    <input type="text" name="" value="" class="special_textbox" placeholder="Amt" id="delivery_charge" disabled/></td>
                                </tr>
                                ...
                                <tr style="background-color:#F5F5F5;">
                                    ...
                                    <td style="text-align:right;padding-right:10px;">
                                    <input type="text" disabled name="" value=""  class="special_textbox" placeholder="Amt" id="tax_charge" disabled/>
                                    </td>
                                </tr>
                                <!--<tr style="background-color:#F5F5F5;">-->
                                <!--    <td></td>-->
                ...
                <div class="main_right fix">
                    <input style="min-height: 50px; " type="text" name="search" id="search" placeholder="<?php echo lang('name_code_cat_veg_bev_bar'); ?>" />
...
<div class="modal-content" style="overflow-y: auto;max-height:500px;width:450px">  
  ...
  <tr>
    ...
    <th>Action</th>
        ...
        foreach($menu_discount as $row)
        {
            ...
            echo "<td> <button data-amount=".$row->amount."  data-price=".$row->price." id='modal_discount' style='background-color:#6d91f0;color:white'> add </td>";
            echo "</tr>";
        }
        ?>
        </table>
        <br><br>
         ...
         <div class="diskon_button"> 
            <button id="close" style="width:100%;background-color:#dc3545;font-size:14px;color:white" > close </div>
         </div>               
    </div>
            ...
            <div class="modal-content" id="modal_content_sale_details">
                <div class="order_detail_modal_info_holder fix">
                    <div class="top fix">
                            ...
                            <div class="item_modifier_details fix">
                                ...
                                <div class="bottom_total_calculation_hold fix">
                                    ...
                                    <div class="single_row fifth fix">
                                        ...
                                        <div class="second_column fix"><span id="service_charge_order_details">0.00</span></div>
                                    </div>  
                                    <div class="single_row fifth fix">
				     ...
				     <div class="single_row fifth fix">
                                        <div class="first_column fix">Tax Charge</div>
                                        <div class="second_column fix"><span id="tax_charge_order_details">0.00</span></div>
                                    </div>
                                    <div class="single_row sixth fix">
                                        <div class="first_column fix"><?php echo lang('total_payable'); ?></div>
